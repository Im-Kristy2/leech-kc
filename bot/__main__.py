...
def stats(update, context):
    ...
    stats = f'<b>╭──《🌐 Bᴏᴛ Sᴛᴀᴛɪsᴛɪᴄs 🌐》</b>\n' \
            ...
            f'<b>├  💽 Dɪsᴋ : {disk}%</b>\n' \
            f'<b>│</b>\n' \
            f'<b>╰──《 ☣️ @KristyCloud ☣️ 》</b>'
    sendMessage(stats, context.bot, update.message)


def start(update, context):
    buttons = ButtonMaker()
        buttons.buildbutton("Join Kristys Mir Group", "https://t.me/KristyCloud")
        buttons.buildbutton("", "https://t.me/+PRRzqHd31XY3ZWZk")
...
'''
        ...
        sendMarkup('<b>Heyy 👋\n\nIf You Want To Use Me, Go to my Group mahn.. not here</b>', context.bot, update.message, reply_markup)
